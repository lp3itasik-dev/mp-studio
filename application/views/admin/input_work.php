                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Input <small>Work</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('Admin/actinput_work') ?>" id="workinput" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            <div class="card-body">
