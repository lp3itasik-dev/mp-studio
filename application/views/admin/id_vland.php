            ...
            ?>
                <div class="row">
                    <div class="col-md-6 text-center">
                        <iframe width="515" height="382" src="<?= $r->link ?>" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="col-md-6">
                        <h1><?= $r->judul ?></h1>
                        ...
                        <a class="btn btn-primary" href="<?= base_url('Admin/edit_vland?id=') ?><?= $r->id ?>" style="margin-bottom: 10px;"><i class="fas fa-edit"></i> Ubah</a>
...
<script>
    function hapus(id, judul) {
        ...
        document.form.action = '<?= base_url('Admin/acthapus_vland'); ?>';
    }
</script>