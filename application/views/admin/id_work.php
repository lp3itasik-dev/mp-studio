            ...
            ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a class="btn btn-primary" href="<?= base_url('Admin/edit_work?id=') ?><?= $r->id ?>" style="margin-bottom: 10px;"><i class="fas fa-edit"></i> Ubah</a>
                        <a onclick="return hapus(`<?= $r->id ?>`,`<?= $r->foto_karya ?>`,`<?= $r->judul ?>`)" class="btn btn-danger" style="margin-bottom: 10px;"><i class="fas fa-trash"></i> Hapus</a>
                    </div>
                </div>
...
<script>
    function hapus(id, foto_karya, judul) {
        $('#Modal').modal('show');
        ...
        $('[name="id"]').val(id);
        $('[name="foto_karya"]').val(foto_karya);
        $('#name-delete').html(judul);
        document.form.action = '<?= base_url('Admin/acthapus_work'); ?>';
    }
</script>