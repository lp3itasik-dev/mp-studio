    ...
    <section class="content">
        <div class="container-fluid">
            ...
            ?>
                <div class="row">
                    <div class="col-md-6">
                        <img src="../foto/dokumentasi/<?= $r->foto_dokumentasi ?>" alt="" class="rounded responsive-image" style="margin-left: -2px; margin-bottom: 30px;">
                    </div>
                    <div class="col-md-6">
                        <h1><?= $r->judul ?></h1>
                        <p><?= $r->tahun ?></p>
                        ...
                        <a class="btn btn-primary" href="<?= base_url('Admin/edit_dok?id=') ?><?= $r->id ?>" style="margin-bottom: 10px;"><i class="fas fa-edit"></i> Ubah</a>
                        <a onclick="return hapus(`<?= $r->id ?>`,`<?= $r->foto_dokumentasi ?>`,`<?= $r->judul ?>`)" class="btn btn-danger" style="margin-bottom: 10px;"><i class="fas fa-trash"></i> Hapus</a>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <span id="modal-body-delete">
                        <input type="text" name="foto_dokumentasi" hidden>
...
<script>
    function hapus(id, foto_dokumentasi, judul) {
        $('#Modal').modal('show');
        ...
        $('[name="id"]').val(id);
        $('[name="foto_dokumentasi"]').val(foto_dokumentasi);
        $('#name-delete').html(judul);
        document.form.action = '<?= base_url('Admin/acthapus_dok'); ?>';
    }
</script>