        ...
        <div class="container-fluid">
            ...
            ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="<?= base_url('Admin/actedit_dok') ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            <div class="col-md-12">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" name="foto_lama" class="form-control" placeholder="Enter Description" value="<?= $r->foto_dokumentasi ?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Picture</label>
                                    <input type="file" name="foto_dokumentasi" class="form-control" placeholder="Enter Picture">
                                </div>
