                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    ...
                                    foreach ($read as $r) {
                                    ?>
                                        <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../foto/karya/<?= $r->foto_karya ?>);">
                                        </li>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../foto/karya/<?= $r->foto_karya ?>">
                                            <img class="d-block w-100" src="../foto/karya/<?= $r->foto_karya ?>" alt="First slide">
                                        </a>
                                    </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <div class="ratings-review mb-15 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="review">
                                        <a href="#"><?=$r->nama_lengkap?> - <?=$r->kelas?></a>
                                    </div>
                                </div>
                                <!-- Avaiable -->
                            ...
                            <a href="http://mp-studio.politekniklp3i-tasikmalaya.ac.id/Visitor/ket_work?id=<?= $r->id ?>" id="copyLink" hidden>Kunjungi Dokumentasi</a>
