        ...
        <div class="row">
                    ...
                    <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active text-center">
                                <!-- <a class="gallery_img"> -->
                                    <iframe width="415" height="615" src="<?= $r->link ?>" frameborder="0" allowfullscreen></iframe>
            ...
            <div class="col-12 col-lg-5">
                <div class="single_product_desc">
                    ...
                    <a href="http://mp-studio.politekniklp3i-tasikmalaya.ac.id/Visitor/ket_vport?id=<?= $r->id ?>" id="copyLink" hidden>Kunjungi Dokumentasi</a>
